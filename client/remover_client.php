             ...
             <div class="grid-x">
               <div class="cell auto"></div>
                <div class="cell small-12 medium-12 large-12">
                  ...
                  <h2 class="form-cad">Remover Clientes</h2>
					   <div>
						    <form action='../php/client/remover-client-submit.php' method='post' class="form-select">
        						<?php
          							try {
                            ...
                            echo "Erro: ".$e->getMessage();
          							...
          							if($_SESSION['cargo'] == 1)
          							{
          								echo "<table><tr style='text-align: center; font-weight: bolder; font-family: Arial'><td></td><td>Codigo</td><td>Nome</td><td>CPF</td><td>Email</td></tr>";
